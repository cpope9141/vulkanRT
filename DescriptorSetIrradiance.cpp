...
void DescriptorSetIrradiance::create(const LogicalDevice& logicalDevice, GraphicsPipelineIrradiance* gp, CubeMap* cubeMap)
{
...
//protected
void DescriptorSetIrradiance::updateDescriptorSet(const LogicalDevice& logicalDevice)
{
