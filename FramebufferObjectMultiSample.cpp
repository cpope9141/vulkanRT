...
void FramebufferObjectMultiSample::create(const LogicalDevice& logicalDevice, RenderPass* renderPass)
{
...
void FramebufferObjectMultiSample::destroy(const LogicalDevice& logicalDevice) {
